...
typedef struct
{
  ...
  int maxNumCubes = 0;            // an upperbound on the number of cubes, if exceeded abort with exit code 25
  ...
  string learnedClausesFileTest; // test whether the given clauses preserve all models
